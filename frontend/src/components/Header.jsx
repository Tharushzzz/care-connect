  ...
  return (
    <header>
        <nav class="flex bg-[#F7FBFE] p-2.5 items-center justify-between drop-shadow-lg">
            ...
            {/* desktop menu */}
              <div class=" items-center justify-center gap-10 text-lg select-none hidden lg:flex">
              ...
              <div class="items-center justify-center gap-4 pb-0.5 pr-3 select-none hidden sm:flex">
            ...
            {/* menu icon */}
            <button onClick={() => setExpanded(!expanded)} class="w-9 h-9 mr-3 sm:hidden">
              {expanded ? (
        ...
        >
          ...
          <div class="hover:bg-[#f9fafc] hover:rounded-lg w-full py-2 pl-3"> How it Works </div>
          <div class="hover:bg-[#f9fafc] hover:rounded-lg w-full py-2 pl-3"> Services </div>
          <div class="hover:bg-[#f9fafc] hover:rounded-lg w-full py-2 pl-3"> Why Us </div>
          <div class="hover:bg-[#f9fafc] hover:rounded-lg w-full py-2 pl-3"> Find Caregiver </div>
          
          <div class="bg-white border border-[#0686CD] w-full text-center p-1.5 px-4 rounded-xl text-[#5E656A] cursor-pointer text-lg hover:bg-[#B5D8EB] hover:text-[#0687cd] transition-colors ease-in-out">
            Log In
          </div>

          <div class="bg-[#0686CD] w-full text-center p-1.5 px-4 rounded-xl text-[#E2F1FF] cursor-pointer text-lg hover:bg-[#0071A8] hover:shadow-lg transition-all ease-in-out delay-75">
            Get Started
          </div>
