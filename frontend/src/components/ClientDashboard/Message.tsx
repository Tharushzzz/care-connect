...
import { Search, Send, Paperclip, Image, Smile, Phone, Video, Info, ArrowLeft, CheckCheck, Loader2, MessageSquare } from 'lucide-react';
      ...
      try {
        ...
        if (res.ok) {
          ...
          const mapped: ChatThread[] = data.map((t: any) => ({
            ...
            name: t.name,
            role: t.role,
            avatar: t.avatar || getCaregiverAvatar(t.caregiverId) || 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=160&q=80',
        ...
        <div className="flex-1 overflow-y-auto divide-y divide-gray-50">
          {loading ? (
            <div className="p-8 text-center text-gray-400">
              <Loader2 className="w-6 h-6 text-[#0686CD] animate-spin mx-auto mb-2" />
              ...
              return (
                ...
                >
                  ...
                  <div className="relative shrink-0">
                    <img
                      src={thread.avatar || 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=160&q=80'}
          ...
          <div className="flex-1 flex flex-col items-center justify-center p-8 text-center text-gray-400">
            {loading ? (
              <>
                ...
                <p className="text-sm font-medium text-gray-600">Loading messages from server...</p>
              </>
            ) : (
              <>
                <MessageSquare className="w-12 h-12 mb-3 text-gray-300" />
                <p className="text-sm font-medium text-gray-700">Select a conversation to start chatting</p>
                <p className="text-xs text-gray-400 mt-1">Choose a contact from the list on the left</p>
              </>
            )}
          </div>
        ) : (
          <>
            ...
            <div className="h-16 px-4 border-b border-[#E4EDF5] bg-white flex items-center justify-between shrink-0 shadow-xs">
              <div className="flex items-center gap-3.5 min-w-0">
                ...
                <div className="relative shrink-0">
                  <img
                    src={activeThread.avatar || 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=160&q=80'}
                    alt={activeThread.name || 'User'}
