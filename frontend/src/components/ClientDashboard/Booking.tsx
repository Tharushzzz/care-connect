  ...
  useEffect(() => {
    const fetchBookings = async () => {
      try {
        ...
        console.error('Failed to fetch bookings from MongoDB:', err);
      } finally {
        setLoading(false);
      }
    };
      ...
      <div className="space-y-4">
        {loading ? (
          <div className="bg-white rounded-2xl border border-[#E4EDF5] p-12 text-center">
            <Loader2 className="w-8 h-8 text-[#0686CD] animate-spin mx-auto mb-3" />
              ...
              <div className="flex flex-col lg:flex-row justify-between gap-5">
                ...
                <div className="flex flex-row lg:flex-col items-center lg:items-end justify-between lg:justify-center shrink-0 gap-3 border-t lg:border-t-0 pt-4 lg:pt-0 border-gray-100">
                  <div className="text-left lg:text-right">
                    ...
                    <span className="text-lg font-extrabold text-[#0D182B]">Rs. {booking.totalPrice.toLocaleString(undefined, { minimumFractionDigits: 2 })}</span>
                  </div>
