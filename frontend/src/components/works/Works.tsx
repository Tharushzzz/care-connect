...
const Works = () => {
  return (
    <div id='works' className="flex flex-col py-20 lg:pt-16 gap-20 items-center justify-center xl:h-screen bg-linear-to-b from-[#e2f1ff83] to-[#a5caca] scroll-mt-13">
