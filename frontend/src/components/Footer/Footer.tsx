...
const Footer = () => {
  return (
    <div className="flex flex-col items-center justify-center w-full h-fit bg-[#0F172A]">
        ...
        <div className="flex items-center justify-between px-5 border-t border-[#ffffff44] w-3/4 py-6 text-center text-[#FFFFFFB2]">
            <p className="text-white/50">&copy; 2023 CareConnect. All rights reserved.</p>
